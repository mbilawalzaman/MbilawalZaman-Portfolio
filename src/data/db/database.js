...
const database = {
  information: {
    ...
    aboutContent:
      "I am a MERN Stack web developer. I can provide clean code and pixel perfect design. I also make website more & more interactive with web animations.",
    age: 33,
    phone: "",
    ...
    address:
      "House 325, Laurex colony, Allama Iqbal road gharhi shahou Lahore, Pakistan",
  ...
  services: [
    {
      ...
      icon: "brush-alt",
      details:
        "MERN stack developer, I specialize in building full-stack web applications using MongoDB, Express.js, React.js, and Node.js.",
    },
    {
      title: "Web Development",
      icon: "code",
      details:
        "I excel in crafting robust and scalable web solutions tailored to your business needs. I ensure seamless integration of front-end and back-end components.",
    },
    // {
  ...
  reviews: [
    ...
    },
    {
      id: 2,
      content:
        "It was a pleasure collaborating with this MERN stack developer. Their attention to detail and commitment to quality were evident throughout the project. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Expedita impedit nobis tempore quaerat quibusdam.",
      author: {
        name: "Ahmed",
        designation: "Client",
      },
    },
    {
      id: 3,
      content:
        "Fantastic work! This MERN stack developer exceeded our expectations. Their ability to transform ideas into reality is remarkable. Lorem ipsum dolor, sit amet consectetur adipisicing elit.",
      author: {
        name: "Dev Tech",
